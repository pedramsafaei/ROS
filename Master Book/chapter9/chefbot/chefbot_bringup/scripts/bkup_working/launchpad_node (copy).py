...
#Subscribers and Publishers
        ...
        self._Left_Encoder = rospy.Publisher(
            'left_encoder', Float32, queue_size=10)
        self._Right_Encoder = rospy.Publisher(
            'right_encoder', Float32, queue_size=10)
...
# Speed subscriber
        self._left_motor_speed = rospy.Subscriber(
            'left_wheel_speed', Int32, self._Update_Left_Speed)

        self._right_motor_speed = rospy.Subscriber(
            'right_wheel_speed', Int32, self._Update_Right_Speed)
