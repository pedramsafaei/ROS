...
def do_dead_recoking(goal_x, goal_y, yaw_degree):
    ...
    rospy.loginfo("Robot Position: [ %f, %f, %f ]" %
                  (robot_pose_x, robot_pose_y, robot_yaw))
    ...
    while(abs(difference_angle) > delta_angle):
        ...
        try:
            ...
            rospy.loginfo("Difference angle [%f], Distance [%f]" % (
                difference_angle, distance))
    ...
    while(distance > delta_distance):
        ...
        try:
            ...
            rospy.loginfo("Difference angle [%f], Distance [%f], Obstacle [%d]" % (
                difference_angle, distance, obstacle_distance))
